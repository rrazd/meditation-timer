...
export function initSessionScreen(
  ...
  function applySpeakerState(): void {
    ...
    speakerButton.style.background = isMuted ? 'rgba(255,255,255,0.04)' : 'rgba(255,255,255,0.07)';
    speakerButton.style.color      = isMuted ? 'rgba(255,255,255,0.28)' : 'rgba(255,255,255,0.55)';
  }
